...
| [zephyr-firmware-ota](./zephyr-firmware-ota/) | Zephyr RTOS | [Over-the-Air Firmware Updates on Zephyr RTOS with Spotflow](https://spotflow.io/blog/zephyr-firmware-ota?utm_source=github&utm_medium=referral&utm_campaign=firmware_examples_readme&utm_content=link_blog_zephyr_ota) |
| [stm32-cold-chain-monitor](./stm32-cold-chain-monitor/) | Zephyr RTOS | [Remote crash debugging for an STM32 fleet with Zephyr RTOS](https://www.openstm32.org/article9-Remote-crash-debugging-for-an-STM32-fleet-with-Zephyr-RTOS)
